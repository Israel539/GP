...
--
-- Este arquivo já reflete o estado final do banco (schema + todas as
-- migrations até a mais recente aplicadas direto nas tabelas) -- uma
-- instalação nova roda só este arquivo, sem precisar rodar nada de
-- database/migrations/ depois. As migrations continuam existindo separadas
-- só para quem já tem uma instalação rodando e precisa evoluir o banco sem
-- perder dados.
-- ============================================================================
