                    ...
                    <form action="/Contato/enviar" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="email_contato" name="email" placeholder="seu@email.com" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="assunto" class="form-label">Assunto</label>
                            <input type="text" class="form-control" id="assunto" name="assunto" placeholder="Ex: Dúvida sobre o sistema" required>
                        </div>

                        <div class="mb-3">
                            <label for="mensagem" class="form-label">Sua Mensagem</label>
                            <textarea class="form-control" id="mensagem" name="mensagem" rows="4" placeholder="Escreva aqui detalhadamente o que você precisa..." required></textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-center align-items-center mb-3">
                            ...
                            &nbsp;&nbsp;
                            <button type="submit" class="btn btn-primary btn-md ps-4 pe-4"><i class="bi bi-send me-2"></i>Enviar Mensagem</button>
                        </div>
                    </form>
                </div>
            </div>
